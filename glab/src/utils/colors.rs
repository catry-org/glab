...
impl Colors {
    ...
    pub fn from_color_code(colors: Colors) -> ColorCode {
        match colors {
            ...
            Colors::BgGray => ColorCode {
                start: 100,
                end: 49,
            },
            Colors::BgBrightRed => ColorCode {
                start: 101,
                end: 49,
            },
            Colors::BgBrightGreen => ColorCode {
                start: 102,
                end: 49,
            },
            Colors::BgBrightYellow => ColorCode {
                start: 103,
                end: 49,
            },
            Colors::BgBrightBlue => ColorCode {
                start: 104,
                end: 49,
            },
            Colors::BgBrightMagenta => ColorCode {
                start: 105,
                end: 49,
            },
            Colors::BgBrightCyan => ColorCode {
                start: 106,
                end: 49,
            },
            Colors::BgBrightWhite => ColorCode {
                start: 107,
                end: 49,
            },
